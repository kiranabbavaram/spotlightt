...
export default function AuthForm() {
  ...
  return (
    <motion.div
      ...
      className="mx-auto w-full max-w-sm rounded-lg border border-gray-100 bg-white p-6 shadow-sm"
    >
      <motion.h2 
        variants={itemVariants}
        className="mb-5 text-center text-lg font-medium text-gradient-primary"
      >
      ...
      <motion.div variants={itemVariants}>
        <Button
          type="button"
          className="w-full rounded-md border border-gray-200 bg-white text-xs text-black hover:bg-gray-50 hover:border-gray-300"
        ...
        {mode === "signup" && (
          <motion.div variants={itemVariants} className="space-y-1">
            ...
            <Input
              ...
              required
              className="h-8 rounded-md border-gray-200 text-xs focus:border-black focus:ring-black input-clean"
            />
          </motion.div>
        )}
        ...
        <motion.div variants={itemVariants} className="space-y-1">
          ...
          <div className="relative">
            <Input
              ...
              required
              className="h-8 rounded-md border-gray-200 pr-8 text-xs focus:border-black focus:ring-black input-clean"
            />
            <button
              type="button"
      ...
      <motion.div variants={itemVariants} className="mt-5 text-center">
        <p className="text-xs text-gray-500">
          ...
          <Button
            ...
            variant="link"
            className="h-auto p-0 text-xs font-normal text-black hover:text-gray-800"
            type="button"
          >
